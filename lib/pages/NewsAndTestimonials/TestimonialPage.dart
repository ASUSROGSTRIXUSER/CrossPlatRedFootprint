...
Firestore.instance.collection("Events").document("TestimonialVideoID").snapshots().listen((videoids)async{
setState(() {
  ...
  Widget build(BuildContext context) {
    return YoutubePlayerBuilder(
      ...
      player: YoutubePlayer(
        ...
        onEnded: (data) {
          _controller.load(videos[(videos.indexOf(data.videoId) + 1) % videos.length]);
            ...
            Padding(
             ...
             /*     Row(
              ...
              /*   Row(
                  ...
                  _space,
       ListView.builder( shrinkWrap: true,itemCount: videos.length, itemBuilder: (context,index){
        ...
        onPressed: _isPlayerReady
            ? () {
                if (_idController.text.isNotEmpty) {
                  ...
                  if (action == 'Previous')  _controller.load(videos[
                                (videos.indexOf(_controller.metadata.videoId) -
                                        1) %
                                    videos.length])
                            ;
                  if (action == 'Next') _controller.load(videos[
                                (videos.indexOf(_controller.metadata.videoId) +
                                        1) %
                                    videos.length]);
